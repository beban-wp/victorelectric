...
require_once get_stylesheet_directory() . '/inc/woocommerce/orders/customer-installment-status.php';

// Include installment orders tab
require_once get_stylesheet_directory() . '/inc/woocommerce/orders/installment-orders.php';
